...
DEFAULT = SilkLayout(
    ...
    contact_line_step_mm=Mm(2.5),
    contact_line_h_mm=Mm(1.35),
    contact_qr_center_y_mm=PreviewY(33.0),
    text_left_mm=Mm(5.0),
    contact_x_mm=Mm(16.5),
    name_y_mm=PreviewY(10.0),
    name_cap_height_mm=Mm(5.5),
    name_font_face="Baskerville SemiBold",
    name_text_thickness_mm=Mm(0.65),
    silk_font_face="Helvetica Neue",
    silk_text_thickness_mm=Mm(0.12),
    name_dilate_k=3,
    roles_y0_mm=PreviewY(18.5),
    roles_line_step_mm=Mm(2.7),
    role_font_size_mm=Mm(1.8),
    contact_font_size_mm=Mm(1.7),
